...
```html
<div
  style="position: relative; width: 100%; padding-bottom: 120%; overflow: hidden;"
>
  <iframe
    src="https:/directory.havenathome.ca/embed.html"
    width="100%"
...
<iframe
  ...
  --
>
  frameborder="0" style="border: none;" title="Toronto Seniors Directory"
  ></iframe
>
```
...
3. Replace `https:/directory.havenathome.ca/embed.html` with your actual URL

### Method 2: Shortcode (if you have a plugin)

```php
[iframe src="https:/directory.havenathome.ca/embed.html" width="100%" height="800px"]
```
